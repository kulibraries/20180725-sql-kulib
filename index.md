...
venue: "SQL Workshop for KU Libraries"        # brief name of host site without address (e.g., "Euphoric State University")
...
startdate: 2018-07-25      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-07-25        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
helper: ["Erika Dickey", "Brad Engelbert", "Marcella Huggard", "Jennifer Johnson", "Miloche Kottman"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: http://pad.software-carpentry.org/20180725-sql-kulib            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
{% endcomment %}
<p id="requirements">
  <strong>Equipment:</strong> Participants will be using DB Browser for SQLite installed on KU Libraries' laptop computers running Windows 10. To install DB Browser for SQLite on a personal computer, follow the instructions <a href="#setup">below</a>. Participants are required to abide by
  {% if page.carpentry == "swc" %}
...
<p>
  To install DB Browser for SQLite on a personal computer, follow the instructions described below. For installation on your work computer, you may need to arrange Windows administrative permission with your supervisor.
</p>
{% comment %}
<p>
...
<div id="sql"> {% comment %} Start of 'SQLite' section specific to DB Browser for SQLite. {% endcomment %}
